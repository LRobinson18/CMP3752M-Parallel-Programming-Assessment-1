...
int main(int argc, char **argv) {
	...
	try {
		...
		std::cout << "Cumulative Histogram kernel execution time [ns]: " << cum_hist_event.getProfilingInfo<CL_PROFILING_COMMAND_END>() - cum_hist_event.getProfilingInfo<CL_PROFILING_COMMAND_START>() << std::endl;
		...
		std::cout << "Vector kernel execution time [ns]: " << back_proj_event.getProfilingInfo<CL_PROFILING_COMMAND_END>() - back_proj_event.getProfilingInfo<CL_PROFILING_COMMAND_START>() << std::endl;
